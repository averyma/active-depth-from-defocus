...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_integer("image_number", 1000, "Number of images in your tfrecord, default is 300.")
flags.DEFINE_integer("class_number", 10, "Number of class in your dataset/label.txt, default is 3.")
